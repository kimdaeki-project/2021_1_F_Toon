   ...
   <!-- partial -->
    <div class="page-body">
      ...
      <div class="page-content-wrapper">
           <div class="container">	
		<br>
		<center><h2>포인트 충전 내역 조회</h2></center>
		<br>
		...
		<table class="table">
			...
			<ul class="pagination">
				...
				<c:forEach begin="${pager.startNum}" end="${pager.lastNum}" var="i">
					<li class="page-item"><a class="page-link p" href="/mypage2/pointCharge/?username=${memberVO.username}&curPage=${i}" title="${i}">${i}</a></li>
				</c:forEach>
