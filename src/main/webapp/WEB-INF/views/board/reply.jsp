...
<c:import url="../fragments/header.jsp"></c:import>
 ...
 <h2><p><span style="border-radius: 15px 15px 15px 0; border: 3px solid #FFE150; 
		padding: 0.5em 0.6em; color: black; background-color:#FFFF96; ">답변</span></p></h2><br>
  ...
  <form id="frm" action="./reply" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" readonly="readonly" value="${member.username}" class="form-control" id="username" name="username">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="5" id="contents" name="qnaContents"></textarea>
    </div>
    ...
    <input type="submit" id="btn" value="작성" class="btn btn-primary">
  </form>
</div>
